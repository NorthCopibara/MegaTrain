...
namespace Qbik.Static.Data
{
    public static class AllData
    {
        ...
        public static List<GameObject> PoolActivEnemy => poolActivEnemy;
        ...
        public static List<EnemyData> EnemyDataPool => enemyDataPool;
        ...
        public static GameObject EndGame => endGame; 
        
        public static Zone DataZone => dataZone; 
        
        public static int NumberCar => numberCar; 
        
        public static int NumberSpawn => numberSpawn;

        public static LvlState Lvl => lvl;

        public static ControlSystemData CSData => csData;

        public static State StateGame => stateGame;

        public static void UpCar()
        {
            numberCar++;
        }
        ...
        public static void InitData(Player player, List<Enemy> enemy, State state, ControlSystemData cs, Zone zone, GameObject end)
        {
            defoultEnemy = enemy;
